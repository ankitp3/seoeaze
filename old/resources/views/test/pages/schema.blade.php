...
@section('hreflangs')
    <link rel="alternate" href="https://www.seoeaze.in/schema-generator" hreflang="en-in" />
    <link rel="alternate" href="https://www.seoeaze.com/schema-generator" hreflang="en-us" />
    <link rel="alternate" href="https://www.seoeaze.co.uk/schema-generator" hreflang="en-gb" />
    <link rel="alternate" href="https://www.seoeaze.com/schema-generator" hreflang="x-default" />
@endsection
@section('title', 'Schema Generator Online | SeoEaze')

@section('meta' , "Schema Generator Online, India.")
  ...
  },
{
    ...
    "item": "https://www.seoeaze.in/schema-generator"
  }]
}
</script>
...
<!-- slider area bar start-->
	...
	<main class="header-video-sec contactheaderbgimg">
    ...
    <div id="home" class="tab-pane active"><br>
      	...
      	<section id="main-section">
                                            ...
                                            <section id="right-section">
                                                ...
                                                <label for="script_code" class="label_script_style"><span class="radio_text">Script</span></label><span class="or_span">or</span>
                                                <input type="radio" name="script_type" id="wordpress_script_1" value="wordpress_script" style="display: none;">
                                                <label for="wordpress_script_1" class="label_script_style_1"><span class="radio_text">Wordpress</span></label>
                                                <div id="wordpress_block" style="display: none;">
                                                    <input type="radio" checked="checked" id="post_page" name="select_type" value="post"> <span for="post_page" class="radio_text">Post</span>
                                                    <input type="radio" name="select_type" id="page_page" value="page"> <span for="page_page" class="radio_text">Page</span>
...
<!-- Json Code Generator  -->
        ...
        jQuery(document).ready(function($) {
            $('body').on('click', 'a', function(e) {
                ...
                var $this = $(this),
                    ...
                    page_slug = '/seo/tools/faq-rich-snippet-generator-tool/',
                    home_url = 'https://www.matthewwoodward.co.uk';
    ...
    <script type="text/javascript">
        ...
        var thirsty_global_vars = {
            "home_url": "\/\/www.matthewwoodward.co.uk",
            "ajax_url": "https:\/\/www.matthewwoodward.co.uk\/wp-admin\/admin-ajax.php",
            "link_fixer_enabled": "",
            "link_prefix": "get",
    ...
    <script type="text/javascript">
        /* <![CDATA[ */
        var tve_dash_front = {
            "ajaxurl": "https:\/\/www.matthewwoodward.co.uk\/wp-admin\/admin-ajax.php",
            "force_ajax_send": "1",
            "is_crawler": ""
        }; /* ]]> */
    </script>
