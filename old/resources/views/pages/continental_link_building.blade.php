...
@section('content')
    ...
    <section class="b-diagonal-line-bg-light b-infoblock--small ">
        <div class="container">
            <h1 class="f-primary-b text-danger text-center">Contentual Link Building</h1>
    ...
    <section class="b-infoblock">
        <div style="background:url(../../public/assets/img/font-bg.png)no-repeat center; width:1000px; margin:0 auto">
