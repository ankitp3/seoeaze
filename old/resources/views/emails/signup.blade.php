...
<body>
                ...
                <div class="contain">
                    ...
                    <img src="https://www.seoeaze.com/assets/images/ic_person_white_48dp_2x.png" alt="" style="width: 100px; margin: 0px auto 30px auto; height: 100px; border-radius:50%; background:#e1e3e7; padding: 10px">
                        
                    <h3 style="text-align: center;margin: 10px; padding: 0px; font-family: 'Noto Sans',sans-serif; color:black; ">
                        {{-- Congratulations Robert!--}}
                    </h3>
                    <p style="font-size: 19px; line-height: 27px; Margin-bottom: 16px;color: #96969f; text-align: center; font-family: 'Noto Sans',sans-serif;">
                        Dear {{ $user }}
                    </p>
				        <p>
					      Your request to create a new user in SeoEaze has been approved.Please click on the link and enter your  and e-mail address that you used when creating a new user.  In the Password field, enter the password specified below.
				        </p>
                        <br>
                        Username
                    <p>
