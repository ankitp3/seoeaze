@extends('layouts.master')
            ...
            <style>
                ...
                .faqscontentwriting-sec { display: block; float:left; text-align: center; padding: 5% 0; height: auto; color: #ffffff; background: white;	}
.faqscontentwriting-sec h2 {font-size: 31px;font-weight: 600;color: #ad0c0c;letter-spacing: 0.4px;}
.faqscontentwriting-innersec {text-align: left;font-size: 17px;color: #9f9a9a;line-height: 27px; margin: 2%;}
.faqscontentwriting-innersec p { line-height: 25px; text-align: left; font-size: 14px; }
.faqscontentwriting-innersec .btn-link {font-weight: 400;color: #ad0c0c;text-decoration: none;font-size: 21px;}
.faqscontentwriting-innersec .card-body {-ms-flex: 1 1 auto;flex: 1 1 auto;}
.accordion .card-header:after {font-family: 'FontAwesome';  content: "\f068";float: right;color: #ad0c0c;}
.accordion .card-header.collapsed:after {/* symbol for "collapsed" panels */content: "\f067"; color: #ad0c0c;}
.faqscontentwriting-innersec a:not([href]):not([tabindex]) {color: #ad0c0c;}

.askaquoteVerticalsec {margin: 0 2%!important;}
.askaquoteVerticalinnersec { display: block; padding: 2%!important;margin: 0 2%!important;background: rgb(188,90,82)!important;background: linear-gradient(211deg, rgba(188,90,82,1) 0%, rgba(50,47,154,1) 55%)!important;text-align: center!important;}
.askaquoteVerticalinnersec h2 {font-size: 21px!important;color: white!important;}
            </style>

            @section('title', 'Test service number 3')
            @section('meta' , 'sdfsdfsd')
            @section('header')
            ...
            <div class="j-menu-container"></div>
                ...
                <section class="b-diagonal-line-bg-light b-infoblock--small ">
                    <div class="container">
                        <h1 class="f-primary-b text-danger text-center">sdfdsfsdf</h1>
                        <h2 class="f-primary-b text-black text-center">sdfsdf</h2>
                        <div class="row b-col-default-indent">
                            <div class="col-md-6 col-xs-12">
                                ...
                                <ul class="c-primary c--inherit b-list-markers f-list-markers b-list-markers--without-leftindent f-list-markers--medium c-primary--all f-color-primary b-list-markers-2col f-list-markers-2col">
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i></a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i></a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i></a></li>
                                        <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i></a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i></a></li>
