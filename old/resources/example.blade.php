@extends('layouts.admin')
            ...
            <div class="j-menu-container"></div>
                ...
                <section class="b-diagonal-line-bg-light b-infoblock--small ">
                    <div class="container">
                        <h1 class="f-primary-b text-danger text-center">asdsadsad</h1>
                        <h2 class="f-primary-b text-black text-center">asdasdasd</h2>
                        <div class="row b-col-default-indent">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <iframe width="560" height="315" src='"https://www.youtube.com/embed/FrdPsi8aP4w' frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </section>
