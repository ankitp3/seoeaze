...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $directory_uri; ?>/dist/lightbox.min.css" media="all" />
    ...
    <script src="<?php echo $directory_uri; ?>/js/lightbox.js?v=1.4"></script>
