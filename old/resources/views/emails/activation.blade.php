...
<body>
                ...
                <div class="contain">
                    ...
                    <img src="https://www.seoeaze.com/assets/img/emailer_img/email-template-img1.jpg" alt="" style="margin:0;padding:0;border:0px; margin-bottom: 0px" >
                       
                    </div>
                    <div class="rcod" style="margin-top: -4px;">
                        <p> Your request to create a new user in SEO EAZE has been approved. Please click on the link and enter your and e-mail address that you used when creating a new user. In the Password field, enter the password specified below.</p><br>
                         Password {{$password}}
                    </div>
                    <div class="rcod" style="margin-top: -6px;">
                        ...
                        <img src="https://www.seoeaze.com/assets/img/emailer_img/email-template-img3.jpg" alt="" style="margin:0;padding:0;border:0px;" >
                    </div>
                </div>
