...
class HomeController extends Controller
{
    ...
    public function seoService(){
        ...
        if(!Session::has('cart')){
            return view('pages.seo_service' , ['data' => $data , 'services' => $services , 'plan_name' => $plan_name, 'service_info' => $service]);
        }else{
            $oldCart  = Session::get('cart');
            $cart  = new Cart($oldCart);
            return view('pages.seo_service' , ['products' => $cart->items , 'plan_name' => $plan_name,  'totalPrice' =>  $cart->totalPrice ,  'data' => $data , 'service_info' => $service, 'services' => $services]);
        }
    }
    ...
    public function articleSubmissionService(){
        ...
        $services = $this->service->get();
        if(!Session::has('cart')){
            return view('pages.article_submision' , ['data' => $data , 'services' => $services]);
        }else{
            $oldCart  = Session::get('cart');
            $cart  = new Cart($oldCart);
            return view('pages.article_submision' , ['products' => $cart->items , 'totalPrice' =>  $cart->totalPrice , 'data' => $data , 'services' => $services]);
        }
    }
    */
