            ...
            <?php if( epcl_get_option('enable_share_header') ): ?>
                <div class="share-buttons hide-on-tablet hide-on-mobile">
                    <?php if( epcl_get_option('facebook_url') ): ?>
                        <a href="<?php echo esc_url( epcl_get_option('facebook_url') ); ?>" target="_blank" aria-label="Facebook"><i class="fa fa-facebook"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('twitter_url') ): ?>
                        <a href="<?php echo epcl_get_option('twitter_url'); ?>" target="_blank" aria-label="Twitter"><i class="fa fa-twitter"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('linkedin_url') ): ?>
                        <a href="<?php echo epcl_get_option('linkedin_url'); ?>" target="_blank" aria-label="Linkedin"><i class="fa fa-linkedin"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('instagram_url') ): ?>
                        <a href="<?php echo epcl_get_option('instagram_url'); ?>" target="_blank" aria-label="Instagram"><i class="fa fa-instagram"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('pinterest_url') ): ?>
                        <a href="<?php echo epcl_get_option('pinterest_url'); ?>" target="_blank" aria-label="Pinterest"><i class="fa fa-pinterest"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('dribbble_url') ): ?>
                        <a href="<?php echo epcl_get_option('dribbble_url'); ?>" target="_blank" aria-label="Dribbble"><i class="fa fa-dribbble"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('tumblr_url') ): ?>
                        <a href="<?php echo epcl_get_option('tumblr_url'); ?>" target="_blank" aria-label="Tumblr"><i class="fa fa-tumblr"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('youtube_url') ): ?>
                        <a href="<?php echo epcl_get_option('youtube_url'); ?>" target="_blank" aria-label="Youtube"><i class="fa fa-youtube"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('flickr_url') ): ?>
                        <a href="<?php echo epcl_get_option('flickr_url'); ?>" target="_blank" aria-label="Flickr"><i class="fa fa-flickr"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('vk_url') ): ?>
                        <a href="<?php echo epcl_get_option('vk_url'); ?>" target="_blank" aria-label="Vkontakte"><i class="fa fa-vk"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('telegram_url') ): ?>
                        <a href="<?php echo epcl_get_option('telegram_url'); ?>" target="_blank" aria-label="Telegram"><i class="fa fa-telegram"></i></a>
                    <?php endif; ?>
                    <?php if( epcl_get_option('rss_url') ): ?>
                        <a href="<?php echo epcl_get_option('rss_url'); ?>" target="_blank" aria-label="RSS"><i class="fa fa-rss"></i></a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
