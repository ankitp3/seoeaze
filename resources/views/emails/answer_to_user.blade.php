...
<body>
                ...
                <div class="contain">
                    ...
                    <img src="https://www.seoeaze.com/assets/img/emailer_img/email-template-img1.jpg" alt="" style="margin:0;padding:0;border:0px; margin-bottom: 25px" >
                        Your Request To change Order Details {{ $answer }}
                    </div>
                    <div class="rcod" style="margin-top: -4px;">
                        <p> If you did not make this request or if you believe someone has used your email without your authorization</p>
                    </div>
