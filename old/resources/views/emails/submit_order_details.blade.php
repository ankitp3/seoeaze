                    ...
                    <div class="rcod" style="margin-top: -4px;">
                      ...
                      <br>
                        <p>
                            ...
                            Qty - {{ $order->qty }}
                            <br>
                            Order More info - {{ $inpputs['other_details'] }}
                            <br>
                            Content Preview - {{ $inpputs['content_preview_status'] }}
                        </p>
                        <div style="display: none">
                            {{ $caount = 0}}
                        </div>

                        @foreach(json_decode($inpputs['order_info'] , true)  as  $each_url)
                            <div style="display: none">
                                {{ $caount ++ }}
                            </div>
                            <div class="col-lg-6" style="color: black; text-align: center; font-family: 'Noto Sans', sans-serif;  font-size: 20px">
                                 {{$caount}}st  Url - {{$each_url['0']}}
                                <br>
                            </div>
                            <div class="col-lg-6" style="color: black; text-align: center; font-family: 'Noto Sans', sans-serif;  font-size: 20px">
                                Keywords - {{$each_url['1']}}
