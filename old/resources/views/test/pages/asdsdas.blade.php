@extends('layouts.master')
            ...
            <div class="j-menu-container"></div>
                ...
                <section class="b-diagonal-line-bg-light b-infoblock--small ">
                    <div class="container">
                        <h1 class="f-primary-b text-danger text-center">asdasdasd</h1>
                        <h2 class="f-primary-b text-black text-center">asdasd</h2>
                        <div class="row b-col-default-indent">
                            <div class="col-md-6 col-xs-12">
                                ...
                                <ul class="c-primary c--inherit b-list-markers f-list-markers b-list-markers--without-leftindent f-list-markers--medium c-primary--all f-color-primary b-list-markers-2col f-list-markers-2col">
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>asddasd</a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>dasdas</a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>sdas</a></li>
                                        <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>dasdasd</a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>sad</a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>asdasd</a></li>
                                    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>asd</a></li>
                                </ul>
                            </div>
                            <div class="col-md-6 col-xs-12">
                                <iframe width="560" height="315" src='asdasd' frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </section>
