            ...
            <div class="row">
                <div class="col-lg-12 heading">
                    ...
                    <ul id="crumb" class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa fa-calendar-times-o" aria-hidden="true"></i>
                            Incomplate Orders
                        </li>
                    </ul>
                    <!-- End .breadcrumb -->
                                ...
                                <table class="table-fill" id="">
                                    ...
                                    <tr>
                                        ...
                                        @if(Auth::user()->role_id ==1 || Auth::user()->role_id ==2 || Auth::user()->role_id ==3)
                                            <th class="text-left">Send Email</th>
                                        @endif
                                    ...
                                    @foreach($orders as $order)
                                        ...
                                        <tr>
                                            ...
                                            @if(Auth::user()->role_id ==1 || Auth::user()->role_id ==2 || Auth::user()->role_id ==3)
                                                <td>
                                                    <a href="/send_email_to_complate_order/{{ $order->email }}/{{$order->order_id}}">
                                                        <button class="btn btn-default navi_404">
                                            ...
                                            @if(Auth::user()->role_id == 4 || Auth::user()->role_id == 5 || Auth::user()->role_id == '' )
                                                <td width="10%">
                                                    <a href="/complate_order/{{ $order->order_id }}">
