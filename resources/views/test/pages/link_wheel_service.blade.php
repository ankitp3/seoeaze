...
@if(!empty($service_info->service_header))
    <section class="b-diagonal-line-bg-light b-infoblock--small ">
        ...
        <div class="container">
            ...
            <div class="row b-col-default-indent">                @if(!empty($service_info->service_video_link))

                    <div class="col-md-6 col-xs-12"><p

                                class="f-primary-l">                            {{$service_info->service_description}}                        </p>
                        ...
                        <ul class="c-primary c--inherit b-list-markers f-list-markers b-list-markers--without-leftindent f-list-markers--medium c-primary--all f-color-primary b-list-markers-2col f-list-markers-2col">
                            @if(!empty($service_info->text_field_one))
                                <li><a href="#"><i
                                                class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_one}}
                                    </a>
                                </li>
                            @else
                            @endif
                            @if(!empty($service_info->text_field_two))
                                <li><a href="#"><i
                                                class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_two}}
                                    </a>
                                </li>
                            @else
                            @endif
                            @if(!empty($service_info->text_field_three))
                                <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_three}}
                                    </a>
                                </li>


                            @else                            @endif                            @if(!empty($service_info->text_field_four))

                                <li><a href="#"><i

                                                class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_four}}

                                    </a>

                                </li>                            @else                            @endif                            @if(!empty($service_info->text_field_five))

                                <li><a href="#"><i

                                                class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_five}}

                                    </a>

                                </li>                            @else                            @endif                            @if(!empty($service_info->text_field_six))

                                <li><a href="#"><i

                                                class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_six}}

                                    </a>

                                </li>                            @else                            @endif                            @if(!empty($service_info->text_field_seven))

                                <li><a href="#"><i

                                                class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_seven}}

                                    </a>

                                </li>                            @else                            @endif                            @if(!empty($service_info->text_field_eight))

                                <li><a href="#"><i

                                                class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_eight}}
                    ...
                    <div class="col-md-6 col-xs-12">
                        ...
                        <iframe width="560" height="315" src="{{$service_info->service_video_link}}" frameborder="0"
                ...
                <div class="col-md-12 col-xs-12"><p
                    ...
                    <ul class="c-primary c--inherit b-list-markers f-list-markers b-list-markers--without-leftindent f-list-markers--medium c-primary--all f-color-primary b-list-markers-2col f-list-markers-2col">
                        @if(!empty($service_info->text_field_one))
                            ...
                            </li>                        @else                        @endif                        @if(!empty($service_info->text_field_two))
                            ...
                            </li>                        @else                        @endif                        @if(!empty($service_info->text_field_three))

                            <li><a href="#"><i

                                            class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i>{{$service_info->text_field_three}}

                                </a>

                            </li>                        @else                        @endif                        @if(!empty($service_info->text_field_four))
