...
<div class="contain">
        ...
        <div class="rcod" style="margin-top: -4px;">
            <h4 style="color:black">The client Personal information</h4><br>
            Email : {{ $email }}<br>
			Name : {{ $name }}<br>
            Subject: {{ $subject }}<br><br>
            Massage<br>{{$massage}}<br><br>
            <p style="font-size:12px"> If you did not make this request or if you believe someone has used your email without your authorization, please contact</p>
        </div>
