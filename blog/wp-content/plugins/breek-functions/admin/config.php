<?php
    /**
     * ReduxFramework Main Config File
    ...
    $args = array(
        ...
        'display_name'         => __('Theme Options Panel', 'epcl_framework'),
        ...
        'menu_title'           => __( 'Theme Options', 'epcl_framework'),
        'page_title'           => __( 'Theme Options', 'epcl_framework'),
        // You will need to generate a Google API key to use this feature.
        // Please visit: https://developers.google.com/fonts/docs/developer_api#Auth
        'google_api_key'       => 'AIzaSyB2MRmVYYNhE-5E-C3OwMXLaNGwxsyTw1I',
	...
	$args['intro_text'] = '<p>'.$theme->get('Description').'</p>';
   ...
   // Sections
    ...
    // require_once('sections/general-settings.php');
