@extends('layouts.master')
            ...
            @section('title', 'Testing service')
            @section('meta' , 'This is testing meta tag ')
            @section('header')
            ...
            <div class="j-menu-container"></div>
                ...
                <section class="b-diagonal-line-bg-light b-infoblock--small ">
                    <div class="container">
                        <h1 class="f-primary-b text-danger text-center">Testing page</h1>
                        <h2 class="f-primary-b text-black text-center">This is testing page</h2>
                        <div class="row b-col-default-indent">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <iframe width="560" height="315" src='https://www.youtube.com/embed/ez20QbyCnH8' frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
                </section>
