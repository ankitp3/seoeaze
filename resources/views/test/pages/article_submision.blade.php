...
@section('hreflangs')
<link rel="alternate" href="https://www.seoeaze.com/article_submission" hreflang="en-us" />
<link rel="alternate" href="https://www.seoeaze.co.uk/article_submission" hreflang="en-gb" />
<link rel="alternate" href="https://www.seoeaze.in/article_submission" hreflang="en-in" />
<link rel="alternate" href="https://www.seoeaze.com/article_submission" hreflang="x-default" />
@endsection
...
@section('content')
    ...
    <section class="b-diagonal-line-bg-light b-infoblock--small ">
        <div class="container">
            <h1 class="f-primary-b text-danger text-center">Article Submission Service</h1>
                ...
                <div class="b-shortcode-example">
                    <div class="b-tabs f-tabs j-tabs b-tabs-reset b-tabs--secondary f-tabs--secondary ui-tabs ui-widget ui-widget-content ui-corner-all">
                        ...
                        <div class="b-tabs__content">
                            ...
                            <div aria-hidden="true" style="display: none;" role="tabpanel" aria-labelledby="ui-id-5" id="tabs-32" class="clearfix ui-tabs-panel ui-widget-content ui-corner-bottom">
                            </div>
