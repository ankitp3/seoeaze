			...
			echo $before_widget;
				...
				echo '<div class="icons title">';
					...
					if( $epcl_theme['twitter_url'] && $enable_twitter != false )
						echo '<a href="'.$epcl_theme['twitter_url'].'" class="twitter" target="_blank"><i class="fa fa-twitter"></i><p>'.esc_html__('Twitter', 'reco').' <span>'.esc_html__('Follow me!', 'reco').'</span></p></a>';

					if( $epcl_theme['facebook_url'] && $enable_facebook != false )
						echo '<a href="'.$epcl_theme['facebook_url'].'" class="facebook" target="_blank"><i class="fa fa-facebook"></i><p>'.esc_html__('Facebook', 'reco').' <span>'.esc_html__('Follow me!', 'reco').'</span></p></a>';

					if( $epcl_theme['instagram_url'] && $enable_instagram != false )
                        echo '<a href="'.$epcl_theme['instagram_url'].'" class="instagram" target="_blank"><i class="fa fa-instagram"></i><p>'.esc_html__('Instagram', 'reco').' <span>'.esc_html__('Our photos!', 'reco').'</span></p></a>';

                    if( $epcl_theme['linkedin_url'] && $enable_linkedin != false )
						echo '<a href="'.esc_url( $epcl_theme['linkedin_url'] ).'" class="linkedin" target="_blank"><i class="fa fa-linkedin"></i> <p>'.esc_html__('Linkedin', 'reco').' <span>'.esc_html__('Visit me!', 'reco').'</span></p></a>';

					if( $epcl_theme['pinterest_url'] && $enable_pinterest != false )
						echo '<a href="'.$epcl_theme['pinterest_url'].'" class="pinterest" target="_blank"><i class="fa fa-pinterest"></i><p>'.esc_html__('Pinterest', 'reco').' <span>'.esc_html__('Pin it!', 'reco').'</span></p></a>';

					if( $epcl_theme['dribbble_url'] && $enable_dribbble != false )
						echo '<a href="'.$epcl_theme['dribbble_url'].'" class="dribbble" target="_blank"><i class="fa fa-dribbble"></i><p>'.esc_html__('Dribbble', 'reco').' <span>'.esc_html__('Our work!', 'reco').'</span></p></a>';

					if( $epcl_theme['tumblr_url'] && $enable_tumblr != false )
						echo '<a href="'.$epcl_theme['tumblr_url'].'" class="tumblr" target="_blank"><i class="fa fa-tumblr"></i><p>'.esc_html__('Tumblr', 'reco').' <span>'.esc_html__('Visit me!', 'reco').'</span></p></a>';

					if( $epcl_theme['youtube_url'] && $enable_youtube != false )
						echo '<a href="'.$epcl_theme['youtube_url'].'" class="youtube" target="_blank"><i class="fa fa-youtube"></i> <p>'.esc_html__('Youtube', 'reco').' <span>'.esc_html__('Check my videos!', 'reco').'</span></p></a>';

					if( $epcl_theme['flickr_url'] && $enable_flickr != false )
                        echo '<a href="'.$epcl_theme['flickr_url'].'" class="flickr" target="_blank"><i class="fa fa-flickr"></i><p>'.esc_html__('Flickr', 'reco').' <span>'.esc_html__('See more photos!', 'reco').'</span></p></a>';

                    if( $epcl_theme['twitch_url'] && $enable_twitch != false )
                        echo '<a href="'.$epcl_theme['twitch_url'].'" class="twitch" target="_blank"><i class="fa fa-twitch"></i><p>'.esc_html__('Twitch', 'reco').' <span>'.esc_html__('Check my videos!', 'reco').'</span></p></a>';
                        
                    if( $epcl_theme['vk_url'] && $enable_vk != false )
                        echo '<a href="'.$epcl_theme['vk_url'].'" class="vk" target="_blank"><i class="fa fa-vk"></i><p>'.esc_html__('VKontakte', 'reco').' <span>'.esc_html__('Follow me!', 'reco').'</span></p></a>';   
                        
                    if( $epcl_theme['telegram_url'] && $enable_telegram != false )
						echo '<a href="'.$epcl_theme['telegram_url'].'" class="telegram" target="_blank"><i class="fa fa-telegram"></i><p>'.esc_html__('Telegram', 'reco').' <span>'.esc_html__('Follow me!', 'reco').'</span></p></a>';  

					if( $epcl_theme['rss_url'] && $enable_rss != false )
						echo '<a href="'.$epcl_theme['rss_url'].'" class="rss" target="_blank"><i class="fa fa-rss"></i><p>'.esc_html__('RSS', 'reco').' <span>'.esc_html__('Get our latest news!', 'reco').'</span></p></a>';
