                                ...
                                <table class="table-fill" id="">
                                    ...
                                    @foreach($orders as $order)
                                        ...
                                        <tr>
                                            ...
                                            @if(Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                                                <td>
                                                    <select name="{{$order->id}}" class="form-control order_status">
                                                        <option @if($order->order_efit_status == '') selected
                                                                @endif value=""></option>
                                                        <option @if($order->order_efit_status == 'edit') selected
                                                                @endif value="edit">On Progress
                                                        </option>
                                                        <option @if($order->order_efit_status == 'done') selected
                                                                @endif value="done">Done
                                                        </option>
                                                    </select>
                                                </td>
                                            @endif
                                            @if($order->sample_report != '')
                                                <td class="text-center">

                                                    <a href="/assets/files/{{$order->sample_report}}">
