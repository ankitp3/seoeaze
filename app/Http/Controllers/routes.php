...
Route::post('getCheckout', ['as'=>'getCheckout','uses'=>'PayumoneyController@getCheckout']);
Route::get('getDone','PaypalController@getDone');
Route::get('getCancel', ['as'=>'getCancel','uses'=>'PayumoneyController@getCancel']);
...
Route::post('/signup', 'UsersController@signup');
    ...
    Route::post('/home_page_form_raghav' , 'UsersController@homePageForm');
...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('/invoice_pay/{id}', 'PayumoneyController@invoicePay');
});
});
